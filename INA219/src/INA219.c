...
uint16_t Read16(INA219_t *ina219, uint8_t Register)
{
	...
	HAL_I2C_Mem_Read_DMA(ina219->ina219_i2c, (INA219_ADDRESS<<1), Register, 1, Value, 2);
...
void Write16(INA219_t *ina219, uint8_t Register, uint16_t Value)
{
	...
	HAL_I2C_Mem_Write_DMA(ina219->ina219_i2c, (INA219_ADDRESS<<1), Register, 1, (uint8_t*)addr, 2);
}
